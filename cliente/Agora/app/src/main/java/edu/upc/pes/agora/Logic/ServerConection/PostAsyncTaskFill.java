...
import edu.upc.pes.agora.Presentation.FillProfileActivity;
import edu.upc.pes.agora.Presentation.MainActivity;

import static edu.upc.pes.agora.Logic.Utils.Constants.SH_PREF_NAME;

public class PostAsyncTaskFill extends AsyncTask<JSONObject, Void, JSONObject> {
    private URL url;
    private Context context;


    public PostAsyncTaskFill(String url2, Context coming_context) {
        try {
            url = new URL(url2);
